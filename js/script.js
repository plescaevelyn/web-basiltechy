...
function corsud_fl() {
 ...
 $('#load_data').click(function(){
  $.ajax({
   url:"https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/vaccinations/country_data/Albania.csv",
   dataType:"text",
...
function domrep_fl() {
	...
	fetch("https://corona.lmao.ninja/v2/countries/dominicanrepublic")
	.then((response) => {
		return response.json();
	})
	.then((data) => {
...
const apiKey = "96ac90b91f49b68270a5aa705ef84aad";
